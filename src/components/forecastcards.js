...
export default (props) => {
    return(
        <div className="row justify-content-md-center text-center mb-4">
            <div className="col-md-1 future-predictions animated slideInUp faster">
            ...
            <div className="col-md-1 offset-md-1 future-predictions animated slideInUp fast">
            ...
            <div className="col-md-1 offset-md-1 future-predictions animated slideInUp">
            ...
            <div className="col-md-1 offset-md-1 future-predictions animated slideInUp slow">
